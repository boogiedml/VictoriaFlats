...
const RoomBookingDetails = ({ room, closeDetails }) => {
  return (
    <div className="relative bg-white p-2 lg:rounded-lg overflow-y-scroll w-full h-full lg:h-auto lg:w-[90%] xl:w-[80%] text-start align-middle transition-all transform shadow-xl">
      <div className="w-fit sticky lg:absolute bg-secondaryBackground lg:bg-transparent p-2 rounded-full text-white lg:text-gray-500 top-4 right-5 cursor-pointer lg:hover:text-black">
      ...
      <div className="overflow-scroll flex flex-col lg:flex-row items-stretch">
        ...
        <div className="w-full lg:w-1/2 p-2 xl:p-8">
          ...
          <p className="font-semibold text-secondaryBackground text-4xl my-5">
            ₦{room.roomPrice}
          </p>
          ...
          <div>
            <button className="flex items-center justify-center gap-4 w-full bg-mainBackground text-white transition-all duration-500 font-semibold p-3 rounded-md">
