...
const Footer = () => {
  return (
    <div className="text-white bg-secondaryBackground px-5 md:px-10 lg:px-14 xl:px-20 pt-16 md:pt-28">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10 md:mb-14">
        <div className="md:pr-4 mb-4 md:mb-0">
          <div className="logo relative text-xl md:text-2xl lg:text-3xl font-syne font-semibold mb-5 md:mb-8 after:w-[10%] md:after:h-[3px] after:bg-white after:absolute after:left-0 after:-bottom-3">
            Victoria Flats
          </div>
